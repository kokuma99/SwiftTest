...
class JFNewFeatureCell: UICollectionViewCell {
    ...
    private lazy var startButton: UIButton = {
        ...
        button.setBackgroundImage(UIImage(named: "a.jpg"), forState: UIControlState.Normal)
        button.setBackgroundImage(UIImage(named: "a.jpg"), forState: UIControlState.Highlighted)
